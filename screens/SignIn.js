...
import { View, StyleSheet, TextInput, Alert, TouchableOpacity, Text, ImageBackground } from 'react-native';
      ...
      <View style={styles.container}>
        <ImageBackground source={require('../assets/SignInScreen.png')} style={styles.image}>
          <View style={styles.contentContainer}>
            ...
            {this.state.secureTextEntry? <Ionicon name="eye-off-outline" size={20} color="#00ADB5" />: <Ionicon name="eye-outline" size={24} color="#00ADB5" />}
            </TouchableOpacity>
              </View>
            </View>
